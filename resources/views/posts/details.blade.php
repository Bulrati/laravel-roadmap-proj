...
@section('content')
    <div class="container">
        ...
        <div class="d-flex flex-column align-items-end">
            <span>Created: {{App\Helpers\DateHelpers\Helper::transformDate($post->created_at, config('constants.dateFormat') )}}</span>
            <span>Updated: {{App\Helpers\DateHelpers\Helper::transformDate($post->updated_at, config('constants.dateFormat'))}}</span>
        </div>
